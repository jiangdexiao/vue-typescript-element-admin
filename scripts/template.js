...
import { ${capPirName}Data } from '@/interface/${dirName}.interface'
...
// vuex 模版
const vuexTep = `import { ${capPirName}State } from '@/interface/${dirName}.interface'
...
fs.mkdirSync(`${basePath}/${dirName}`) // mkdir
...
process.chdir(`${basePath}/interface`) // cd types
